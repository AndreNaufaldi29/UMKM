...
export const SortIcon = (props) => (
  <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
    <path d="M3 7h13M3 12h9M3 17h5M17 4v16m0 0 4-4m-4 4-4-4" />
  </svg>
);
...
export const PhoneIcon = (props) => (
  <svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
    <path d="M22 16.9v3a2 2 0 0 1-2.2 2 19.8 19.8 0 0 1-8.6-3 19.5 19.5 0 0 1-6-6 19.8 19.8 0 0 1-3-8.7A2 2 0 0 1 4.1 2h3a2 2 0 0 1 2 1.7c.1.9.3 1.9.6 2.7a2 2 0 0 1-.5 2.1L8 9.7a16 16 0 0 0 6 6l1.2-1.2a2 2 0 0 1 2.1-.5c.9.3 1.8.5 2.7.6a2 2 0 0 1 1.7 2Z" />
  </svg>
);
...
export const FbIcon = (props) => (
  <svg width="17" height="17" viewBox="0 0 24 24" fill="currentColor" {...props}>
    <path d="M13.5 21v-7.9h2.66l.4-3.1h-3.06V8.1c0-.9.25-1.5 1.53-1.5h1.64V3.8A22 22 0 0 0 14.2 3.6c-2.3 0-3.9 1.4-3.9 4V10H7.6v3.1h2.7V21h3.2Z" />
  </svg>
);
...
export const TiktokIcon = (props) => (
  <svg width="17" height="17" viewBox="0 0 24 24" fill="currentColor" {...props}>
    <path d="M16.6 3c.5 2.2 2 3.9 4.4 4.2v3.1c-1.6.1-3-.4-4.4-1.3v6.6c0 3.6-2.9 6.4-6.4 6.4S3.8 19.2 3.8 15.6c0-3.5 2.8-6.3 6.2-6.4v3.2c-1.7.1-3 1.5-3 3.2 0 1.8 1.4 3.2 3.2 3.2s3.3-1.4 3.3-3.2V3h3.1Z" />
  </svg>
);
...
export const CatIcons = {
  ...
  Kerajinan: (props) => (
    <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
      <path d="m14.5 2.5 7 7L12 19l-7.5 1.5L6 13l8.5-10.5Z" />
      <path d="m17.5 5.5 1 1" />
    </svg>
  ),
  Fashion: (props) => (
    <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
      <path d="M9 3 12 6l3-3 5 4-3 3-2-1v11H8V9L6 10 3 7l6-4Z" />
    </svg>
  ),
  Pertanian: (props) => (
    <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
      <path d="M12 22V12M12 12c0-4-3-7-7-7 0 4 3 7 7 7Zm0 0c0-4 3-7 7-7 0 4-3 7-7 7Z" />
    </svg>
  ),
  Jasa: (props) => (
    <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
      <path d="M14.7 6.3a4 4 0 1 1-5.4 5.4L3 18v3h3l6.3-6.3a4 4 0 0 1 5.4-5.4l-2.3 2.3-2-2 2.3-2.3Z" />
    </svg>
  ),
  Wisata: (props) => (
    <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
      <path d="m8 3-6 18h20L14 3l-3 6-3-6Z" />
    </svg>
  ),
};

export const CategoryIcon = ({ cat, ...props }) => {
  const IconComponent = CatIcons[cat];
  if (!IconComponent) return null;
  return <IconComponent {...props} />;
};

export const StarIcon = (props) => (
  <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
